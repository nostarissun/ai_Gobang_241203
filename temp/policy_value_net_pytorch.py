...
class PolicyValueNet():
    ...
    def __init__(self, board, availables, last_move, board_width, board_height,
    ...
    def get_current_state(self):
        ...
        if self.board:
            ...
            square_state[0][move_curr // width,
                            move_curr % height] = 1.0
            square_state[1][move_oppo // width,
                            move_oppo % height] = 1.0
            
            square_state[2][self.last_move // width,
    ...
    def policy_value_fn(self, board, availables):
        ...
        current_state = np.ascontiguousarray(self.get_current_state().reshape(
